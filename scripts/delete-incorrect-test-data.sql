...
DECLARE
  ...
  v_deleted_audit_logs_count int;
...
BEGIN
  ...
  WHERE account_id = '2d612868-852e-4a80-9d02-9d10383898d4';
  GET DIAGNOSTICS v_deleted_audit_logs_count = ROW_COUNT;
  ...
  RAISE NOTICE 'Deleted % transactions, % items, % audit_logs, % transaction_audit_logs for Test Account', v_deleted_transactions_count, v_deleted_items_count, v_deleted_audit_logs_count, v_deleted_transaction_audit_logs_count;
END;
$$ LANGUAGE plpgsql;
