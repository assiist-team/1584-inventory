const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Projects.js","assets/vendor.js","assets/router.js","assets/inventoryService.js","assets/firebase.js","assets/dateUtils.js","assets/BudgetProgress.js","assets/ui.js","assets/ItemDetail.js","assets/imageService.js","assets/ImagePreview.js","assets/ImageGallery.js","assets/ProjectDetail.js","assets/AddItem.js","assets/transactionSources.js","assets/EditItem.js","assets/AddTransaction.js","assets/ImageUpload.js","assets/EditTransaction.js","assets/TransactionDetail.js"])))=>i.map(i=>d[i]);
var lt=t=>{throw TypeError(t)};var ze=(t,e,n)=>e.has(t)||lt("Cannot "+n);var o=(t,e,n)=>(ze(t,e,"read from private field"),n?n.call(t):e.get(t)),g=(t,e,n)=>e.has(t)?lt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),f=(t,e,n,s)=>(ze(t,e,"write to private field"),s?s.call(t,n):e.set(t,n),n),E=(t,e,n)=>(ze(t,e,"access private method"),n);var Ee=(t,e,n,s)=>({set _(r){f(t,e,r,n)},get _(){return o(t,e,s)}});import{r as b,a as bn,b as In}from"./vendor.js";import{L as Tn,O as An,R as xn,a as K,B as Sn}from"./router.js";import{c as de,L as Pn,I as Cn,A as En,X as On,C as jn,a as Fn}from"./ui.js";import{r as Fe,_ as Re,C as _e,a as qe,E as Nt,o as Rn,F as Ut,L as _n,g as Qt,i as Dn,b as kn,v as Mn,c as dt,d as qn,e as Ln,f as Nn,h as Un,j as Qn,k as $n,l as Kn,s as zn,T as Bn}from"./firebase.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();var $t={exports:{}},Le={};/**
 * @license React
